...
void test_should_call_trim_passing_a_string_with_tabs_spaces_at_the_beggining_and_expects_the_string_without_it()
{
    std::string input("\t\t\t\tmy text");
    std::string expected("my text");
...
void test_should_call_trim_passing_a_string_with_tabs_spaces_at_the_the_end_and_expects_the_string_without_it()
{
    std::string input("my text\t\t\t\t\t");
    std::string expected("my text");
